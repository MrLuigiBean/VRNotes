...
export class CameraGizmo extends Gizmo {
     ...
     */
    constructor(gizmoLayer = UtilityLayerRenderer.DefaultUtilityLayer, gizmoColor) {
        super(gizmoLayer);
    ...
    set camera(camera) {
        ...
        if (camera) {
            ...
            const linesColor = (_b = (_a = this._gizmoColor) === null || _a === void 0 ? void 0 : _a.toColor4(1)) !== null && _b !== void 0 ? _b : new Color4(1, 1, 1, 1);
