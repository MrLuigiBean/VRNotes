...
export class GaussianSplatting {
    ...
    _createMaterial(scene) {
        ...
        const shaderMaterial = new ShaderMaterial("GaussianSplattingShader", scene, {
    ...
    _setData(binaryData) {
        ...
        for (let i = 0; i < vertexCount; i++) {
            ...
            quaternion.set((this._uBuffer[32 * i + 28 + 1] - 128) / 128, (this._uBuffer[32 * i + 28 + 2] - 128) / 128, (this._uBuffer[32 * i + 28 + 3] - 128) / 128, -(this._uBuffer[32 * i + 28 + 0] - 128) / 128);
    ...
    constructor(name, scene) {
        ...
        this._minimum = new Vector3();
        this._maximum = new Vector3();
        /**
         * Name of the GS that is also used to name a mesh for rendering it
         */
        this.name = "GaussianSplatting";
        this._worker = null;
        this.scene = scene;
        this.name = name;
    ...
    _loadData(data) {
        ...
        this._setData(new Uint8Array(data));
        const matricesData = new Float32Array(this.vertexCount * 16);
        const updateInstances = (indexMix) => {
            var _a;
            ...
            (_a = this.mesh) === null || _a === void 0 ? void 0 : _a.thinInstanceBufferUpdated("matrix");
        };
        ...
        this._worker = new Worker(URL.createObjectURL(new Blob(["(", GaussianSplatting._CreateWorker.toString(), ")(self)"], {
        ...
        this._sceneBeforeRenderObserver = this.scene.onBeforeRenderObservable.add(() => {
            ...
            (_a = this._worker) === null || _a === void 0 ? void 0 : _a.postMessage({ view: this._modelViewMatrix.m, positions: this._positions });
        });
    ...
    dispose() {
        ...
        (_a = this._worker) === null || _a === void 0 ? void 0 : _a.terminate();
        this._worker = null;
        (_b = this.mesh) === null || _b === void 0 ? void 0 : _b.dispose();
        this.mesh = null;
    }
}
GaussianSplatting._VertexShaderSource = `
...
GaussianSplatting._FragmentShaderSource = `
...
GaussianSplatting._CreateWorker = function (self) {
    let viewProj;
    let lastProj = [];
    let vertexCount = 0;
    let positions;
