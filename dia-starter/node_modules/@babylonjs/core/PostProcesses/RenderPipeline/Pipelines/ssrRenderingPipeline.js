...
export class SSRRenderingPipeline extends PostProcessRenderPipeline {
    ...
    _updateEffectDefines() {
        ...
        if ((_b = (_a = this._geometryBufferRenderer) === null || _a === void 0 ? void 0 : _a.generateNormalsInWorldSpace) !== null && _b !== void 0 ? _b : (_c = this._prePassRenderer) === null || _c === void 0 ? void 0 : _c.generateNormalsInWorldSpace) {
            defines.push("#define SSR_NORMAL_IS_IN_WORLDSPACE");
        }
        if ((_d = this._geometryBufferRenderer) === null || _d === void 0 ? void 0 : _d.normalsAreUnsigned) {
            defines.push("#define SSR_DECODE_NORMAL");
        }
        (_e = this._ssrPostProcess) === null || _e === void 0 ? void 0 : _e.updateEffect(defines.join("\n"));
    }
    _buildPipeline() {
        var _a;
        if (!this.isSupported) {
